...
SRC_URI="https://github.com/junegunn/fzf/archive/0.44.1.tar.gz -> fzf-0.44.1.tar.gz
https://dev.gentoo.org/~sam/distfiles/app-shells/fzf/fzf-0.44.0-deps.tar.xz -> fzf-0.44.0-deps.tar.xz"
