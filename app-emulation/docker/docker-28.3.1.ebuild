...
SRC_URI="https://github.com/moby/moby/tarball/fed8a0a5feb6e5dd369af7bd1cd383f098bac82e -> moby-28.3.1-fed8a0a.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="fed8a0a"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="28.3.1-funtoo"
