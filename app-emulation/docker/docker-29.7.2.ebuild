...
SRC_URI="https://github.com/moby/moby/tarball/d681cdaead9340bd36c513c7f5413a21bc679cfa -> moby-29.7.2-d681cda.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="d681cda"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.7.2-funtoo"
