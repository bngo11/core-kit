...
SRC_URI="https://github.com/moby/moby/tarball/0ef0b4f2532e05d61d74413ff307d8a761f4ce12 -> moby-29.4.0-0ef0b4f.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="0ef0b4f"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.4.0-funtoo"
