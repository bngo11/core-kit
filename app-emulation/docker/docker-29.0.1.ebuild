...
SRC_URI="https://github.com/moby/moby/tarball/dfdf762391646fb2ecd9b43b5b2751863ed0328e -> moby-29.0.1-dfdf762.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="dfdf762"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.0.1-funtoo"
