...
SRC_URI="https://github.com/moby/moby/tarball/b2d20c90a74af78b3f0f967db92292e4a603c03d -> moby-29.8.1-b2d20c9.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="b2d20c9"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.8.1-funtoo"
