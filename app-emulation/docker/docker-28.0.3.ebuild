...
SRC_URI="https://github.com/moby/moby/tarball/b4fceb0c56362852d2dd2a92852ee02effeefd40 -> moby-28.0.3-b4fceb0.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="b4fceb0"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="28.0.3-funtoo"
