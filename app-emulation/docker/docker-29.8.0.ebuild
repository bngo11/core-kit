...
SRC_URI="https://github.com/moby/moby/tarball/dc4db3d292c317ca216dae9301dffc935c8d7680 -> moby-29.8.0-dc4db3d.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="dc4db3d"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.8.0-funtoo"
