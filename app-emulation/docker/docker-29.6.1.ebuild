...
SRC_URI="https://github.com/moby/moby/tarball/5259f1f37f10f37594a18eab40604e3e91622fe9 -> moby-29.6.1-5259f1f.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="5259f1f"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.6.1-funtoo"
