...
SRC_URI="https://github.com/moby/moby/tarball/45b9763eb121e5d726793b62030fc66baf8f97ff -> moby-29.0.3-45b9763.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="45b9763"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.0.3-funtoo"
