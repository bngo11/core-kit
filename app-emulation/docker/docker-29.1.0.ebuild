...
SRC_URI="https://github.com/moby/moby/tarball/ab0910fb285e342a43491868a095052ac24308d8 -> moby-29.1.0-ab0910f.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="ab0910f"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.1.0-funtoo"
