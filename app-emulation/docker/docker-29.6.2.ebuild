...
SRC_URI="https://github.com/moby/moby/tarball/1d2e4ee609f836723774470bce2710ae288a011e -> moby-29.6.2-1d2e4ee.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="1d2e4ee"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.6.2-funtoo"
