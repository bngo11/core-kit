...
SRC_URI="https://github.com/moby/moby/tarball/1a68c67ab6d5a71cd14ee92fbe639bea5391815d -> moby-29.1.4-1a68c67.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="1a68c67"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.1.4-funtoo"
