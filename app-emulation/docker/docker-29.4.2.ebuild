...
SRC_URI="https://github.com/moby/moby/tarball/431a4dc6e61fa4a35a720634a4573d81b3804484 -> moby-29.4.2-431a4dc.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="431a4dc"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.4.2-funtoo"
