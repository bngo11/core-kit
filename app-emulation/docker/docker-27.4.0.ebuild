...
SRC_URI="https://github.com/moby/moby/tarball/f0db17ac4aaf96bf37d1e8d8921e3fb6a170603c -> moby-27.4.0-f0db17a.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="f0db17a"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="27.4.0-funtoo"
