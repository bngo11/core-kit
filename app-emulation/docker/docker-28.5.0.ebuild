...
SRC_URI="https://github.com/moby/moby/tarball/bb0b9a8d8332f0cfda531b136232f71316409fe3 -> moby-28.5.0-bb0b9a8.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="bb0b9a8"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="28.5.0-funtoo"
