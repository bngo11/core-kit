...
SRC_URI="https://github.com/moby/moby/tarball/44c018957ecd6eef2f4ce831cf8c776e6e559601 -> moby-29.2.1-44c0189.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="44c0189"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.2.1-funtoo"
