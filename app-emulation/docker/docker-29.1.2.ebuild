...
SRC_URI="https://github.com/moby/moby/tarball/f1bc7ff050c00cad5c7218947a13560bd6aa22b4 -> moby-29.1.2-f1bc7ff.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="f1bc7ff"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.1.2-funtoo"
