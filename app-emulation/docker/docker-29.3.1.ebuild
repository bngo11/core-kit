...
SRC_URI="https://github.com/moby/moby/tarball/34ddcab43729d02fc486ceea8f01e0effd8bd4ec -> moby-29.3.1-34ddcab.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="34ddcab"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.3.1-funtoo"
