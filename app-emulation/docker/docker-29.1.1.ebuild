...
SRC_URI="https://github.com/moby/moby/tarball/9da8ba05edb8143b338d587d05388b14a170cf32 -> moby-29.1.1-9da8ba0.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="9da8ba0"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.1.1-funtoo"
