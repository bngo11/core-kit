...
SRC_URI="https://github.com/moby/moby/tarball/b5c3467ddde0169d80aade06b47994dca8137fe6 -> moby-29.5.2-b5c3467.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="b5c3467"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.5.2-funtoo"
