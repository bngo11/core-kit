...
SRC_URI="https://github.com/moby/moby/tarball/6f5e53a1d0ade2171f3c27a8fc1cd2ba3e54d8cd -> moby-28.5.1-6f5e53a.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="6f5e53a"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="28.5.1-funtoo"
