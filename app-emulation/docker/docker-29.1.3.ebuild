...
SRC_URI="https://github.com/moby/moby/tarball/3ac9309249510376baefa3b747986b5eeee977f9 -> moby-29.1.3-3ac9309.tar.gz"
...
src_compile() {
	export DOCKER_GITCOMMIT="3ac9309"
	export GOPATH="${WORKDIR}/${P}"
	export VERSION="29.1.3-funtoo"
