...
SRC_URI="https://github.com/curl/curl/releases/download/curl-8_22_0/curl-8.22.0.tar.gz -> curl-8.22.0.tar.gz"

LICENSE="curl"
SLOT="0"
KEYWORDS="*"
IUSE="adns alt-svc brotli +ftp gnutls gopher hsts +http2 idn +imap ipv6 kerberos ldap mbedtls +openssl +pop3 +progress-meter samba +smtp ssh ssl sslv3 static-libs test telnet +tftp threads zstd"
